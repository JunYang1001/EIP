...
public class lookmyactActivity extends AppCompatActivity implements HttpCallBack {
   ...
   private String path="http://10.0.2.2:8080/EIP/MyActivityController/lookmyact.action";
  // private String path="http://192.168.43.216:8080/EIP/MyActivityController/lookmyact.action";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_lookmyact );
        ButterKnife.bind(this);
        final Intent intent=getIntent();
        userid=intent.getStringExtra( "userid" );//登录者id
        ptoolbar.setTitle("我的活动");
        ...
        //区分请求来源，加入标杆
        map.put( "flag","lookmyact" );
        map.put( "userid",userid );
        //将map类型转成固定格式的字符串
        String string= Util.getPair(map);
        HttpTask task=new HttpTask(this);
        //设置数据回调
        task.setCallback(lookmyactActivity.this);
        //开始执行请求
    ...
    public void callback(String respone) {
        if(respone!=null){
            ...
            if(part1.equals("objectlookmyact")){
                Gson gson=new Gson();
                ...
                lv.setOnItemClickListener( new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        aitent = aitent.setClass( lookmyactActivity.this, lookmyactActivity_item.class );
