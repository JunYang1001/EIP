...
public class newcamActivity extends AppCompatActivity  implements HttpCallBack{
  ...
  private String path="http://10.0.2.2:8080/EIP/MyActivityController/typeactivity.action";

    //private String path="http://192.168.43.216:8080/EIP/MyActivityController/typeactivity.action";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_newcam );
        ButterKnife.bind(newcamActivity.this);
        final Intent intent=getIntent();
        String datatext=intent.getStringExtra( "cam" );
        String gpscity=intent.getStringExtra( "gpscity" );
         ptoolbar.setTitle("");
        tv1.setText( datatext );

        userid=intent.getStringExtra( "user" );//登录者id
      ...
      switch (datatext){
          case "最新":
              map.put("flag", "getactivitynewData");
               break;
          case "热门":
              map.put("flag", "getactivityhotData");
              break;
          case "附近":
              map.put("flag", "getactivitynearbyData");
              map.put("user", userid);
              gpscity="厦门";
              map.put( "city",gpscity );
              break;
        ...
        //设置数据回调
        task.setCallback(newcamActivity.this);
        //开始执行请求
    ...
    public void callback(String respone) {
            ...
            if(respone!=null){
                ...
                if(part1.equals("objectactivitynew")){
                    ...
                    lv.setOnItemClickListener( new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            aitent = aitent.setClass( newcamActivity.this, tuijianActivity_item.class );
                            Bundle bundle=new Bundle();
                            bundle.putSerializable("activity",list.get( position ));
                            aitent.putExtra( "joinuserid",userid );
                            aitent.putExtras(bundle);
                            startActivity( aitent );
                        }
                    } );
                }
                if(part1.equals("objectactivityhot")){
                ...
                if(part1.equals("objectactivitynearby")){
